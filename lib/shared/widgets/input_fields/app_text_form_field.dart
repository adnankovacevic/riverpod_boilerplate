...
import 'package:riverpod_boilerplate/shared/widgets/decorations/app_input_decoration.dart';
...
class AppTextFormField extends StatelessWidget {
  const AppTextFormField({
    ...
    this.cursorRadius,
    this.cursorColor = AppColors.semiGrey,
    ...
    if (labelText != null) {
      rows.insert(
        ...
        Padding(
          ...
          child: Text(
            labelText!,
            style: textTheme.bodyMedium?.w600,
            textAlign: TextAlign.start,
          ),
        ),
      );
